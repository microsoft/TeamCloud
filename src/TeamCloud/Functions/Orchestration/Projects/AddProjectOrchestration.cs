...
namespace TeamCloud
{
    public static class AddProjectOrchestration
    {
        [FunctionName(nameof(AddProjectOrchestration))]
            ...
            ILogger log)
        {
            ...
            project = await functionContext.CallActivityAsync<Project>(nameof(AddProjectActivity), project);
            ...
            project = await functionContext.CallActivityAsync<Project>(nameof(UpdateProjectActivity), project);
