...
namespace TeamCloud
{
    public static class AddProjectUserOrchestration
    {
        [FunctionName(nameof(AddProjectUserOrchestration))]
            ...
            ILogger log)
        {
            ...
            var project = await functionContext.CallActivityAsync<Project>(nameof(AddProjectUserActivity), (input.orchestratorContext.Project, newUser));
