...
{
    public sealed class ProjectIdentityCommandHandler :
        ...
        ICommandHandler<ProjectIdentityDeleteCommand>
    {
        ...
        public async Task<ICommandResult> HandleAsync(ProjectIdentityCreateCommand command, IAsyncCollector<ICommand> commandQueue, IDurableClient durableClient = null)
        {
            if (command is null)
        ...
        public async Task<ICommandResult> HandleAsync(ProjectIdentityUpdateCommand command, IAsyncCollector<ICommand> commandQueue, IDurableClient durableClient = null)
        {
            if (command is null)
                throw new ArgumentNullException(nameof(command));
        ...
        public async Task<ICommandResult> HandleAsync(ProjectIdentityDeleteCommand command, IAsyncCollector<ICommand> commandQueue, IDurableClient durableClient = null)
        {
            if (command is null)
                throw new ArgumentNullException(nameof(command));
