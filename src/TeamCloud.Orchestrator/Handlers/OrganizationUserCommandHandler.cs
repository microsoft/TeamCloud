...
namespace TeamCloud.Orchestrator.Handlers
{
          ...
          ICommandHandler<OrganizationUserDeleteCommand>
    {
        ...
        public async Task<ICommandResult> HandleAsync(OrganizationUserCreateCommand command, IDurableClient durableClient = null)
        {
            if (command is null)
        ...
        public async Task<ICommandResult> HandleAsync(OrganizationUserUpdateCommand command, IDurableClient durableClient = null)
        {
            if (command is null)
                throw new ArgumentNullException(nameof(command));
        ...
        public async Task<ICommandResult> HandleAsync(OrganizationUserDeleteCommand command, IDurableClient durableClient = null)
        {
            if (command is null)
                throw new ArgumentNullException(nameof(command));
