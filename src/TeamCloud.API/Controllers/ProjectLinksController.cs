    ...
    public class ProjectLinksController : ApiController
    {
        ...
        public Task<IActionResult> Post([FromBody] ProjectLink link) => EnsureProjectAsync(async project =>
        {
            ...
            return await Orchestrator
                .InvokeAndReturnActionResultAsync<ProjectLinkDocument, ProjectLink>(new OrchestratorProjectLinkCreateCommand(currentUser, linkDocument, project.Id), Request)
                .ConfigureAwait(false);
        });
        ...
        public Task<IActionResult> Put([FromRoute] string linkId, [FromBody] ProjectLink link) => EnsureProjectAsync(async project =>
        {
            ...
            return await Orchestrator
                .InvokeAndReturnActionResultAsync<ProjectLinkDocument, ProjectLink>(new OrchestratorProjectLinkUpdateCommand(currentUser, linkDocument, project.Id), Request)
                .ConfigureAwait(false);
        });
        ...
        public Task<IActionResult> Delete([FromRoute] string linkId) => EnsureProjectAsync(async project =>
        {
            ...
            return await Orchestrator
                .InvokeAndReturnActionResultAsync<ProjectLinkDocument, ProjectLink>(new OrchestratorProjectLinkDeleteCommand(currentUser, linkDocument, project.Id), Request)
                .ConfigureAwait(false);
        });
    }
}
