...
//     {
//         public TeamCloudUsersController(UserService userService, Orchestrator orchestrator, IOrganizationRepository organizationRepository, IUserRepository userRepository)
//             : base(userService, orchestrator, organizationRepository, userRepository)
//         { }


//         [HttpGet("api/{orgai}/users")]
...
//             var command = new OrchestratorOrganizationUserCreateCommand(currentUser, userDocument);
...
//             existingUser.PopulateFromExternalModel(user);

//             var command = new OrchestratorOrganizationUserUpdateCommand(currentUser, existingUser);
...
//             var command = new OrchestratorOrganizationUserUpdateCommand(currentUser, currentUser);
...
//             var command = new OrchestratorOrganizationUserDeleteCommand(currentUser, userDocument);
