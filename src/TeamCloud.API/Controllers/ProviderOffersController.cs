...
//             offerDocument = new ComponentOffer()
//                 .PopulateFromExternalModel(offer);

//             return await Orchestrator
//                 .InvokeAndReturnActionResultAsync<ComponentOffer, ComponentOffer>(new OrchestratorComponentOfferCreateCommand(currentUser, offerDocument), Request)
//                 .ConfigureAwait(false);
//         });
...
//             return await Orchestrator
//                 .InvokeAndReturnActionResultAsync<ComponentOffer, ComponentOffer>(new OrchestratorComponentOfferUpdateCommand(currentUser, offerDocument), Request)
//                 .ConfigureAwait(false);
//         });
...
//             return await Orchestrator
//                 .InvokeAndReturnActionResultAsync<ComponentOffer, ComponentOffer>(new OrchestratorComponentOfferDeleteCommand(currentUser, offerDocument), Request)
//                 .ConfigureAwait(false);
//         });
//     }
// }
