...
namespace TeamCloud.Model.Commands
{
    ...
    {
        public BroadcastDocumentCreateCommand(User user, TPayload payload) : base(user, payload, Guid.TryParse(payload?.ETag?.Trim('"'), out var commandId) ? commandId : default)
        { }
    }
}
