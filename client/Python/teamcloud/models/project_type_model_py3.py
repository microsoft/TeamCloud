...
class ProjectTypeModel(ProjectType):
    ...
    def __init__(self, *, id: str=None, default: bool=None, region: str=None, subscriptions=None, subscription_capacity: int=None, resource_group_name_prefix: str=None, providers=None, tags=None, properties=None, **kwargs) -> None:
        super(ProjectTypeModel, self).__init__(id=id, default=default, region=region, subscriptions=subscriptions, subscription_capacity=subscription_capacity, resource_group_name_prefix=resource_group_name_prefix, providers=providers, tags=tags, properties=properties, **kwargs)
