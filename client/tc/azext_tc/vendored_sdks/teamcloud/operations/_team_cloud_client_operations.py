...
def build_negotiate_signal_r_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    # Construct URL
    _url = kwargs.pop("template_url", "/orgs/{organizationId}/projects/{projectId}/negotiate")
    path_format_arguments = {
        "organizationId": _SERIALIZER.url("organization_id", organization_id, 'str'),
        "projectId": _SERIALIZER.url("project_id", project_id, 'str'),
    }
...
# fmt: on
class TeamCloudClientOperationsMixin(object):  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def negotiate_signal_r(  # pylint: disable=inconsistent-return-statements
        self,
        organization_id,  # type: str
        project_id,  # type: str
        **kwargs  # type: Any
